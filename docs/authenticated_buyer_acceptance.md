...
Completed scenarios checkpoint their reports, and response watchers observe action failures immediately so a later timeout cannot erase earlier acceptance evidence.
