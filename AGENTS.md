...
app/
  ...
  dashboard/
    ...
    PokemonCardIndex.tsx  # Pokemon catalog tab of the Card Index (create/edit/merge/link attach/curator flags; create AND edit state edition + finish as typed axes)
